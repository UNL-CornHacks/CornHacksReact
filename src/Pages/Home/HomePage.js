        ...
        <div>
            ...
            >
                ...
                <Question question="What is a Hackathon?">
                    A hackathon is an invention marathon. Students come together
                    to build innovative software and hardware over an extended
                    period. It's{" "}
                    <a
                    ...
                    experience. We would love for you to come and experience a
                    hackathon for yourself!
                </Question>
                <Question question="Where and when will cornhacks take place?">
                    Our original plan was to have the event n January 16th and
                    17th, 2021 @{" "}
                    <a
                        style={{ color: Colors.WHITE }}
                    ...
                    . However, we are currently re-evaluating our options due to
                    the COVID-19 pandemic.
                </Question>
                <Question question="What is the cost to attend CornHacks?">
                    Nothing. $0.00. Free. There is no cost to attend CornHacks.
                    We only ask you bring your creativity and skill.
                </Question>
                <Question question="Do I need any prior experience to register for CornHacks? What if this is my first hackathon?">
                    ...
                    CornHacks. Any and all student participants are welcome! We
                    are happy to help you form a team, get started with your
                    project, and have an awesome first hackathon!
                </Question>
                <Question question="Do I need to be a college student to attend?">
                    Yes, attendees must be currently enrolled undergraduate
                    students at a college/university. Additionally, attendees
                    must be at or over 18 years of age.
                </Question>
                <Question question="Do I need to form a team before I register? What do I do if I do not have a team?">
                    Participants are not required to find a team prior to the
                    event, although you are certainly welcome to do so. At the
                    beginning of the event, we will host a session for all still
                    looking to form a team so you can find others with whom you
                    can work. Teams may have a maximum of four members.
                </Question>
                <Question question="Will there be any swag or prizes?">
                    SO much swag, SO many prizes. All CornHacks attendees will
                    receive a t-shirt, stickers, and tons of other goodies.
                    Teams that win tiered or track prizes will also receive
                    additional prizes; while this year’s prizes are still being
                    determined, previous years have seen prizes such as
                    flatscreen TVs, Nintendo Switches, and high-quality wireless
                    headphones.
                </Question>
                ...
                <Question question="Is there anything I need to do in advance?">
                    There are a couple of things we would ask you do before the
                    event begins: please fill out{" "}
                    <a
                        style={{ color: Colors.WHITE }}
