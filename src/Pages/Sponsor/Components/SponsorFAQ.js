...
const SponsorFAQ = () => (
    <TextSection backgroundColor={Colors.CORN_GREEN}>
        <Type size="h2" bold color={Colors.BLACK}>
            Frequently Asked Questions
        </Type>
        <Question question={"What is Cornhacks?"} color={Colors.BLACK}>
        ...
        <Question question={"Why does CornHacks need sponsors?"} color={Colors.BLACK}>
            <Type size="h5" bold color={Colors.BLACK}>
